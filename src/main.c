...
int main() {
    ...
    // Set player 0 as human, rest as bots
    strcpy(gameState.players[0].username, "Player 0");
    ...
    printf("Winner: %s with $%d in pot\n", gameState.players[winner].username, gameState.pot);
